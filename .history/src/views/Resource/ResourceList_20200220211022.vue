        ...
        <el-row>
          <el-col :span="6">
            <el-form-item prop="issureId" label="发布人用户id">
              <el-input v-model="filters.issureId" placeholder="发布人用户id"  style="padding-left: 5px;" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
        ...
        <el-row>
          <el-col :span="6">
            <el-form-item prop="browseStartNum" label="浏览量">
              <el-input v-model="filters.browseStartNum" clearable style="width: 90px;margin-left: 45px;"></el-input>—
            </el-form-item>
