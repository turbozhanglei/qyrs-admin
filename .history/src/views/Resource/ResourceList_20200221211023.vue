        ...
        <el-row>
          <el-col :span="6">
            <el-form-item prop="browseStartNum" label="浏览量">
              <el-input v-model="filters.browseStartNum" clearable style="width: 86px;padding-left: 42px;"></el-input>&nbsp;&nbsp;&nbsp;—
            </el-form-item>
            <el-form-item prop="browseEndNum">
              <el-input v-model="filters.browseEndNum" clearable style="width: 86px"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
