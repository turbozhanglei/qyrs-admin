<template>
  <div class="page-container">
    ...
    >
      ...
      <el-table-column label="分类ID" width="200" align="center" prop="id"></el-table-column>
      <el-table-column
        label="支持平台"
        width="100"
        align="center"
      ...
      ></el-table-column>
      <el-table-column label="显示顺序" width="200" align="center" prop="sort">
      ...
      ></el-table-column>
      <el-table-column label="修改时间" width="200" align="center" prop="update_time"></el-table-column>
