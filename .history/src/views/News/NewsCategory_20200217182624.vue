    ...
    >
      ...
      >
        ...
        <el-form-item label="排序" prop="sort">
          <el-input v-model="dataForm.sort" maxlength="2" auto-complete="off" :rules="[{type:'number',required: false, message: '请输入数字类型', trigger: 'blur,change'}]" @keyup="inputChange($event)"></el-input>
        </el-form-item>
