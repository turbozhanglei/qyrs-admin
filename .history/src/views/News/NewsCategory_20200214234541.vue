    ...
    >
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="warning" @click="handleEdits(scope.$index, scope.row)" v-if="scope.row.status == 0">添加子类</el-button>
          <el-button
            size="mini"
            type="info"
      ...
      >
        ...
        <el-form-item label="状态" required>
          <el-radio-group  v-model="dataForm.status">
            <el-radio :label="item.value" :key="item.value" v-for="item in status">{{item.label}}</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
