...
export default {
  ...
  methods: {
    ...
    handleEdit: function(index,row) {
      ...
      this_.dataForm=row
      // this_.dataForm.refId=row.ref_id?(parseInt(row.ref_id))?parseInt(row.ref_id):'':''
      this_.$set(this.dataForm, this.dataForm.refId,  row.ref_id?(parseInt(row.ref_id))?parseInt(row.ref_id):'':'')
