  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size" ref="filters" class="form">
        ...
        <el-form-item>
          <el-input v-model="filters.unified_social_credit_code" placeholder="统一社会信用代码"></el-input>
        </el-form-item>
        <el-form-item>
        ...
        <el-form-item>
          ...
          <el-select v-model="filters.industry_type" placeholder="行业类型">
            <el-option
    ...
    >
      ...
      >
        ...
        <el-form-item label="法人证件类型" prop="paperwork_type">
          ...
          <el-select v-model="dataForm.paperwork_type" placeholder="法人证件类型">
            <el-option
              v-for="item in paperwork_type_options"
              :key="item.key"
              :label="item.val"
        ...
        <el-form-item label="客户性质" prop="customer_type">
          <el-select v-model="dataForm.customer_type" placeholder="客户性质">
            <el-option
              v-for="item in customer_type_options"
              :key="item.key"
              :label="item.val"
        ...
        <el-form-item label="行业类型" prop="trade_type">
          <el-select v-model="dataForm.trade_type" placeholder="行业类型">
            <el-option
              v-for="item in trade_type_options"
              :key="item.key"
              :label="item.val"
        ...
        <el-form-item label="经办人证件类型" prop="manager_papertype">
          <el-select v-model="dataForm.manager_papertype" placeholder="法人证件类型">
            <el-option
              v-for="item in paperwork_type_options"
              :key="item.key"
              :label="item.val"
        ...
        <el-form-item label="经办人有效期" prop="manager_effectivetime">
          <el-date-picker
        ...
        <el-form-item label="营业执照有效期" prop="business_date">
          <el-date-picker
        ...
        <el-form-item label="统一社会信用代码" prop="socialcode">
          <el-input v-model="dataForm.socialcode" auto-complete="off"  maxlength="18" show-word-limit></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    findPage: function(data) {
      this.filters.t = "historyCustomer";
      ...
      this.$refs.dataForm.validate(valid => {
        if (valid) {
          this.$confirm("确认提交吗？", "提示", {}).then(() => {
            ...
            params.t = "historyCustomer";
            params.manager_effectivetime = format(params.manager_effectivetime);
    ...
    initColumns: function() {
      this.columns = [
        ...
        { prop: "businessdate", label: "营业执照有效期", minWidth: 120 }
      ];
      var temp = [];
