  ...
  <div class="page-container">
    ...
    >
      ...
      >
        ...
        <el-table-column prop="tray_number" label="存放货位" width="120"></el-table-column>
        ...
        <el-table-column prop="updator_name" label="检验员" width="120"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleDetail: function(data) {
      ...
      this.detailParam.t = "storageStatisticsByCustomer";
