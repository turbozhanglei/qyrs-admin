  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size" class="form">
        <el-row>
          ...
          <el-form-item>
            <el-select v-model="filters.food_add_type" clearable placeholder="食品、食品添加剂类别">
              <el-option
                v-for="item in productOptions"
                :key="item.id"
                :label="item.food_add_type"
                :value="item.food_add_type"
              ></el-option>
            </el-select>
          </el-form-item>
        </el-row>
    ...
    >
      ...
      >
        ...
        <el-table-column prop="order_licence" label="单据证照" width="120"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleDetail: function(data) {
      ...
      this.detailParam.customer_id = data.row.customer_id;
      this.detailParam.t = "outCustomerStatistics";
