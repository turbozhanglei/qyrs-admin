  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			<el-row style="text-align: left;">
				<el-form-item>
				<el-input v-model="filters.code" placeholder="监控设备编码"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.name" placeholder="设备名称"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.modal" placeholder="监控设备型号"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.local" placeholder="放置位置"></el-input>
				</el-form-item>
				<el-form-item>
	...
	<el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
		<el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size"
			...
			<el-row :gutter="20">
				<el-col :span="24">
					<div class="grid-content bg-purple" style="margin-top: -70px;text-align:center" >WMS系统监控设备管理页面</div>
					</el-col>
			</el-row>
			<el-form-item label="监控设备编码" >
				<el-input v-model="dataForm.code" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="设备名称" prop="name">
				<el-input v-model="dataForm.name"  auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="监控设备型号" prop="model">
				<el-input v-model="dataForm.model"  auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="放置位置" prop="local">
				<el-input v-model="dataForm.local"  auto-complete="off"></el-input>
			</el-form-item>
	...
	<el-dialog :title="operation?'打印预览':'打印'" width="35%" :visible.sync="printPage" :close-on-click-modal="false">
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
			<el-tag style="margin-left: 33%;">北京东晓腾飞供应链管理有限公司监控设备标识卡</el-tag>
			<el-row>
				<el-col :span="12">
...
      	initColumns: function () {
			this.columns = [
				...
				{prop:"code", label:"监控设备编码", minWidth:100},
				{prop:"name", label:"设备名称", minWidth:120},
				{prop:"model", label:"监控设备型号", minWidth:120},
				{prop:"local", label:"放置位置", minWidth:120},
