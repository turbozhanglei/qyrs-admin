  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			<el-row style="text-align: left;">
				<el-form-item>
				<el-input v-model="filters.code" placeholder="梯具设备编码"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.name" placeholder="梯具名称"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.modal" placeholder="梯具型号"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.load_weight" placeholder="最大承重(KG)"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.height" placeholder="高度(m)"></el-input>
				</el-form-item>
				<el-form-item>
			...
			<el-row style="text-align: left;">
				...
				<el-form-item>
					...
					<!-- <el-form-item>
					<kt-button :label="$t('action.reset')"  type="primary" @click="resetSelection" />
				</el-form-item> -->
			</el-row>
		</el-form>
	</div>
	...
	<el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
		<el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size"
			...
			<el-row :gutter="20">
				<el-col :span="24">
					<div class="grid-content bg-purple" style="margin-top: -70px;text-align:center;" >WMS系统订单入库页面</div>
					</el-col>
			</el-row>
			<el-form-item label="梯具设备编码" prop="code">
				<el-input v-model="dataForm.code" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="梯具名称" prop="name">
				<el-input v-model="dataForm.name"  auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="梯具型号" prop="model">
				<el-input v-model="dataForm.model"  auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="最大承重(KG)" prop="load_weight">
				<el-input v-model="dataForm.load_weight"  auto-complete="off"></el-input>
			</el-form-item>
	...
	<el-dialog :title="operation?'打印预览':'打印'" width="35%" :visible.sync="printPage" :close-on-click-modal="false">
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
			...
			<el-tag style="margin-left: 33%;">北京东晓腾飞供应链管理有限公司梯具设备标识卡</el-tag>
			<el-row>
				<el-col :span="12">
				...
				<el-col :span="12">
					<el-form-item label="梯具设备编码:" style="margin-left: -6%;margin-top: 25%;">
...
      	initColumns: function () {
			this.columns = [
				...
				{prop:"code", label:"梯具设备编码", minWidth:100},
				{prop:"name", label:"梯具名称", minWidth:120},
				{prop:"model", label:"梯具型号", minWidth:120},
				{prop:"load_weight", label:"最大承重(KG)", minWidth:120},
				{prop:"height", label:"高度(m)", minWidth:120},
