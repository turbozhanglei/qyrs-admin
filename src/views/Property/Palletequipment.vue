  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			<el-row style="text-align: left;">
				<el-form-item>
				<el-input v-model="filters.code" placeholder="托盘设备编码"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.name" placeholder="托盘名称"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.modal" placeholder="托盘型号"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.load_weight" placeholder="最大承重(KG)"></el-input>
				</el-form-item>
				<el-form-item>
				<el-input v-model="filters.volume" placeholder="托盘容积(m3)"></el-input>
				</el-form-item>
				<el-form-item>
	...
	<el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
		<el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size"
			...
			<el-row :gutter="20">
				<el-col :span="24">
					<div class="grid-content bg-purple" style="margin-top: -70px;text-align:center" >WMS系统托盘管理页面</div>
				</el-col>
			</el-row>
			<el-form-item label="托盘设备编码" prop="code">
				<el-input v-model="dataForm.code" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="托盘名称" prop="name">
				<el-input v-model="dataForm.name"  auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="托盘型号" prop="model">
			...
			<el-form-item label="托盘容积(m3)" prop="width_requirement">
	...
	<el-dialog :title="operation?'打印预览':'打印'" width="35%" :visible.sync="printPage" :close-on-click-modal="false">
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
			...
			<el-tag style="margin-left: 33%;">北京东晓腾飞供应链管理有限公司托盘设备标识卡</el-tag>
			<el-row>
				<el-col :span="12">
				...
				<el-col :span="12">
					<el-form-item label="托盘设备编码:" style="margin-left: -6%;margin-top: 25%;">
...
      	initColumns: function () {
			this.columns = [
				...
				{prop:"code", label:"托盘设备编码", minWidth:100},
				{prop:"name", label:"托盘名称", minWidth:120},
				{prop:"model", label:"托盘规格", minWidth:120},
