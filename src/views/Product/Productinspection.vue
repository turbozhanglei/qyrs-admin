    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        ...
        <el-row style="text-align: left;">
          ...
          <el-form-item>
            <el-input v-model="filters.situation_description" placeholder="情况说明"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model="filters.situation_suggest" placeholder="措施建议"></el-input>
          </el-form-item>
        </el-row>
        <el-row style="text-align: left;">
          <el-form-item>
            <!-- <el-input v-model="filters.is_rectificationt" placeholder="是否整改"></el-input> -->
            <el-select v-model="filters.is_rectificationt" style="width:200px" placeholder="是否整改">
              <el-option label="是" value="1">是</el-option>
              <el-option label="否" value="0">否</el-option>
            </el-select>
          </el-form-item>
          <el-form-item>
            <el-input v-model="filters.unrectificationt_reason" placeholder="未整改原因"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model="filters.inspectionker" placeholder="盘库人"></el-input>
          </el-form-item>
          <el-form-item>
            <el-date-picker
              v-model="filters.inspectionk_time"
              style="width:200px"
              type="date"
              placeholder="巡检时间"
              value-format="yyyy-MM-dd"
    ...
    >
      ...
      >
        ...
        <el-row>
          ...
          <el-form-item label="情况说明" prop="situation_description">
            <el-input v-model="dataForm.situation_description" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="是否整改" prop="is_rectificationt">
            <!-- <el-input v-model="dataForm.is_rectificationt" auto-complete="off"></el-input> -->
            <el-select v-model="dataForm.is_rectificationt" style="width:200px" auto-complete="off">
              <el-option label="是" value="1">是</el-option>
              <el-option label="否" value="0">否</el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="未整改原因" prop="unrectificationt_reason">
            <el-input v-model="dataForm.unrectificationt_reason" auto-complete="off"></el-input>
          </el-form-item>

          <el-form-item label="措施建议" prop="situation_suggest">
            <el-input v-model="dataForm.situation_suggest" auto-complete="off"></el-input>
          </el-form-item>
          <!-- <el-form-item label="盘库人" prop="inspectionker">
					<el-input v-model="dataForm.inspectionker" auto-complete="off"></el-input>
          </el-form-item>-->
          <!-- <el-form-item label="巡检时间" prop="inspectionk_time">
					<el-input v-model="dataForm.inspectionk_time" auto-complete="off"></el-input>
					<el-date-picker v-model="dataForm.inspectionk_time" type="date" placeholder="选择日期" style="width:86%" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
          </el-form-item>-->
          <el-form-item label="单据证照" prop="document_license">
            <!-- <el-input v-model="dataForm.document_license" auto-complete="off"></el-input> -->
...
export default {
  ...
  methods: {
    ...
    findPage: function(data) {
      this.filters.t = "productinSpection";
      ...
      if (selVal == "" || selVal == null) {
        ...
        $.each(temp, function(key, val) {
          if (val.id == selVal) {
            ...
            this_.dataForm.order_num = val.bill; //单据号
    ...
    handleEdit: function(params) {
      ...
      var this_ = this;
      var search = {};
      search.id = this_.dataForm.id;
      search.t = "productinSpection";
    ...
    initColumns: function() {
      this.columns = [
        ...
        { prop: "situation_description", label: "情况说明", minWidth: 120 },
        { prop: "situation_suggest", label: "措施建议", minWidth: 120 },
        {
          prop: "is_rectificationt",
          label: "是否整改",
          minWidth: 120,
          formatter: this.location
        },
        { prop: "unrectificationt_reason", label: "未整改原因", minWidth: 120 },
        { prop: "check_name", label: "盘库人", minWidth: 120 },
        { prop: "create_time", label: "巡检时间", minWidth: 120 }
      ];
      var temp = [];
