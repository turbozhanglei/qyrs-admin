  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        ...
        <el-form-item>
          <el-input v-model="filters.unit_weight" placeholder="单位质量"></el-input>
        </el-form-item>
        <el-row>
          <el-form-item>
            <kt-button
    ...
    >
      ...
      >
        ...
        <el-row>
          ...
          <el-form-item label="移至货位" prop="storage_location">
            <!-- <el-input v-model="dataForm.client_name" auto-complete="off"></el-input> -->
            <el-select
              style="width: 200px;"
              v-model="dataForm.storage_location"
              clearable
              filterable
              remote
              reserve-keyword
          ...
          <!-- <el-form-item label="盘库时间" prop="check_time">
						...
						<el-date-picker v-model="dataForm.check_time" type="date" placeholder="选择日期"  value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
          </el-form-item>-->
          <!-- <el-form-item label="货位实物是否一致" prop="isphysical_location">
					...
					<el-select v-model="dataForm.isphysical_location" style="width: 200px;">
							<el-option label="是" value="1">是</el-option>
							<el-option label="否" value="0">否</el-option>
						</el-select>
          </el-form-item>-->
          ...
          <!-- <el-form-item label="是否过期" prop="isexpired">
					<el-select v-model="dataForm.isexpired" style="width: 200px;">
							<el-option label="是" value="1">是</el-option>
							<el-option label="否" value="0">否</el-option>
						</el-select>
          </el-form-item>-->
          ...
          <!-- <el-form-item label="单据证照" prop="document_license">
					 ...
					 <div style="float: left;">
						<ul class="el-upload-list el-upload-list--picture-card">
								<li v-for="(bill_photo,index) in bill_photo_list" :key="index" :tabindex="index" class="el-upload-list__item is-success" >
      ...
      <div>
        ...
        >
          ...
          <el-table-column label="单位体积(m3)" width="180" prop="unit_volume"></el-table-column>
          <el-table-column label="单位重量(kg)" width="180" prop="unit_weight"></el-table-column>
        </el-table>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      dataFormRules: {
        unadjusted_reason: [
          { required: true, message: "请输入未调整原因", trigger: "blur" }
        ],
        isphysical_location: [
          { required: true, message: "请选择货位实物是否一致", trigger: "blur" }
        ],
        product_name: [
  ...
  methods: {
    ...
    findPage: function(data) {
      this.filters.t = "locationTransfer";
    ...
    searchProductMethod: function(query) {
      if (query !== "") {
        ...
        var search = {};
        search.t = "wtray";
        search.sql = "querySiteSettingList";
        search.number = query;
        var this_ = this;
        this.utils.request.queryUserList(search, function(res) {
    ...
    choseProduct: function(selVal) {
      ...
      if (selVal == "" || selVal == null) {
        this_.dataForm.savelocation = "";
      } else {
        $.each(temp, function(key, val) {
          if (val.id == selVal) {
            this_.dataForm.savelocation = val.name;
      ...
      this.$refs.dataForm.validate(valid => {
        if (valid) {
          this.$confirm("确认提交吗？", "提示", {}).then(() => {
            ...
            // 	}
            //  }).join(',')
            this.utils.request.editLocationInfo(params, this.editInfoBack);
          });
        }
      });
    }, // 新增修改回调
    ...
    initColumns: function() {
      this.columns = [
        ...
        { prop: "try_number", label: "托盘号码", minWidth: 120 },
        ...
        { prop: "unit_volume", label: "单位体积", minWidth: 120 },
        { prop: "unit_weight", label: "单位重量", minWidth: 120 },
        ...
        { prop: "move_num", label: "移至货位", minWidth: 120 },
        { prop: "storage_time", label: "入库时间", minWidth: 120 },
        //{prop:"isphysical_location", label:"货位实物是否一致", minWidth:120,formatter:this.isreturn},
        ...
        //{prop:"is_adjustment", label:"是否调整", minWidth:120,formatter:this.isreturn},
        //{prop:"unadjusted_reason", label:"未调整原因", minWidth:120},
        { prop: "check_name", label: "操作人", minWidth: 120 },
        { prop: "create_time", label: "盘操作时间", minWidth: 120 },
