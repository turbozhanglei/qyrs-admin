  ...
  <div class="page-container">
    ...
    >
      <el-table :data="tableData" :columns="columnsdetail">
        <el-table-column prop="sku_name" label="产品名称" width="150"></el-table-column>
        ...
        <el-table-column prop="num" label="库存数量（件数）" width="150"></el-table-column>
      </el-table>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    findPage: function(data) {
      ...
      this.filters.sql = "queryListByOrder";
      this.filters.sqlCount = "queryListByOrderCount";

      this.$refs.CyTable.findPage(this.filters);
    },
    // 获取详细数据
    findPageDetail: function(data) {
      if (data !== null) {
      ...
      this.$api.user
        ...
        .then(res => {
          this.pageResultDetail = {
            content: testdata.contentDetail,
            pageNum: 1,
            pageSize: 10,
            totalPages: 1,
            totalSize: 2
    ...
    handleDetail: function(data) {
      ...
      let query = {};
      let this_ = this;
      query._number = data.row.number;
      query.t = "wOrderNoSaleSku";
      query.sql = "queryList";
    ...
    initColumns: function() {
      this.columns = [
        { prop: "number", label: "申请单编号", minWidth: 120 },
        ...
        { prop: "sku_out_why", label: "出货事由", minWidth: 180 },

        { prop: "tray_number", label: "托盘编号", minWidth: 120 },
        { prop: "setting_num", label: "货位编号", minWidth: 120 },
